...
public class Geotools {
     ...
     */
    public Geotools(DataStore postgisDatasore) throws IOException {
    ...
    public Geotools() throws IOException {
        postgisDatasore = PGDatastore.getDefeaultDatastore();
    }
     ...
     * @return
     */
    public boolean geojson2pgtable(InputStream geojsonPath, String pgtableName) {
        boolean result = false;
        try {

            FeatureJSON featureJSON = new FeatureJSON();
            FeatureCollection featureCollection = featureJSON.readFeatureCollection(geojsonPath);
